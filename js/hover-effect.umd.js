!function (e, t) {
    ...
    return t = t && t.hasOwnProperty("default") ? t.default : t, function (n) {
        function i() {
        ...
        var r = n.parent, o = n.displacementImage, a = n.image1, s = n.image2, f = i(n.imagesRatio, 1),
            d = i(n.intensity1, n.intensity, 1), l = i(n.intensity2, n.intensity, 1), u = i(n.angle, Math.PI / 4),
            v = i(n.angle1, u), m = i(n.angle2, 3 * -u), c = i(n.speedIn, n.speed, 1.6),
            p = i(n.speedOut, n.speed, 1.2), g = i(n.hover, !0), h = i(n.easing, Expo.easeOut), y = i(n.video, !1);
        if (r) if (a && s && o) {
            var x = new e.Scene,
            ...
            if (V.magFilter = V.minFilter = e.LinearFilter, y) {
                ...
                var R = new e.VideoTexture(y), T = new e.VideoTexture(P);
            ...
            var C = new e.ShaderMaterial({
                ...
                transparent: !0,
                opacity: 1
            }), b = new e.PlaneBufferGeometry(r.offsetWidth, r.offsetHeight, 1), D = new e.Mesh(b, C);
