...
const translations = {
    fr: {
        ...
        project_scotland: "Aventure dans les Highlands : un voyage en Écosse",
        ...
        description_scotland: `Plongé dans la beauté sauvage de l'Écosse, ce film de voyage suit un chemin à travers des montagnes brumeuses et des vallées cachées. Les images mettent en valeur la magie brute et intacte des Highlands, mêlant des paysages sereins à l'esprit d'aventure. Ce projet explore non seulement la géographie, mais aussi le voyage émotionnel de la déambulation dans l'un des environnements les plus époustouflants au monde.`,
        info_role: "Réalisateur & Photographe",
    ...
    en: {
        ...
        project_canon: "Camara — Canon R6 Mark III",
        project_scotland: "Highland Adventure: A Scottish Journey",
        project_archives: "Archives",
        ...
        description_scotland: `Immersed in the rugged beauty of Scotland, this travel film follows a path through misty mountains and hidden glens. The footage highlights the raw, untouched magic of the Highlands, blending serene landscapes with the spirit of adventure. his project explores not just the geography, but the emotional journey of wandering through one of the world's most breathtaking environments.`,
        info_role: "Filmmaker & Photographer",
